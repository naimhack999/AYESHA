...
module.exports = {
	...
	onChat: async function ({ event, message, getLang }) {
		if (event.body && event.body.toLowerCase() === "prefix") {
			const ownerName = "𝐀𝐘𝐄𝐒𝐇𝐀 𝐐𝐔𝐄𝐄𝐍";
			const ownerFB = "m.me/ayesha.queen.911";
			
			const prefixInfo = `${getLang("myPrefix", global.GoatBot.config.prefix, utils.getPrefix(event.threadID))}
